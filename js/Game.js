...
async start(){
  ...
  fImg=[fighter1Img,fighter2Img];
  fighterDie=[ fighter1DieImg,fighter2DieImg ];
...
play(){
     ...
     var y = 100;
      ...
      healthbar[index-1].width=allPlayers[plr].width;
        ...
        if (index === player.index){
          ...
          if (player.health<10){
            healthbar[index-1].shapeColor= 'red';
          }
   ...
   if (allPlayers.player1.health ===5 ){
    fighter1 = createSprite (200,500,30,30);
     fighter1.scale=4;
    fighter1.addAnimation('fighter1',fighter1DieImg);
     fill('black');
     text(allPlayers.player1.name+"Has Won The Game",displayWidth/2-10,displayHeight/4-40);
   }else{
    fighter2 = createSprite (670,500,50,50);
   fighter2.scale=5.3;
    fighter2.addAnimation('fighter1',fighter2DieImg);
    fill('black');
    text(allPlayers.player2.name+"Has Won The Game",displayWidth/2-10,displayHeight/4-40);
